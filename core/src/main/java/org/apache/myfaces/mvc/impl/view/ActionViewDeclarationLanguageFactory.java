 ...
 * @author lu4242
 */
public class ActionViewDeclarationLanguageFactory extends ViewDeclarationLanguageFactory
{
    ...
    public ActionViewDeclarationLanguageFactory(ViewDeclarationLanguageFactory delegate)
    {
        ...
        if (ViewDeclarationLanguage.FACELETS_VIEW_DECLARATION_LANGUAGE_ID.equals(vdl.getId()))
        {
            if (faceletsVdl == null)
            {
                synchronized(this)
                {
                    if (faceletsVdl == null)
                    {
                        faceletsVdl = new ActionViewDeclarationLanguageWrapper(vdl);
                    }
                }
            }
            return faceletsVdl;
