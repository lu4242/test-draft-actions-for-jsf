...
public abstract class ActionResponse
{
    ...
    public final void encodeAll(FacesContext facesContext) throws IOException
    {
    ...
    public abstract void encodeContent(FacesContext facesContext) throws IOException;
